...
type BoxCssProps<CP> = {
  // Enhance the CSS props with the parishconnect-box supported values.
  // `string` isn't added because it'll ruin props with string literal types (e.g textAlign)
  [P in keyof CP]: CP[P] | number | boolean | null | undefined | CP[P][] | number[] | boolean[] | null[] | undefined[] | (number | null)[]
};

type InnerBoxPropValue = string | number | boolean | null | undefined;
export type BoxPropValue = InnerBoxPropValue | { [key: string]: any; media: boolean };
